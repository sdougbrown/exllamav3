...
# The full-width selection route exists only while the tiled selection bindings are absent
# (they are CUDA-only); the select-rows test below covers that route.
assert not hasattr(ext, "dsa_topk_tile")
